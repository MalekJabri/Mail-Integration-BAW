...
public class Mail {
     ...
     */
    public static void sendMessage(String smtpHost, String to, String from, String fromName, String replyTo, String cc, String bcc,
    ...
    public static void sendMessageTLS(String smtpHost, String username, String password,String port,boolean tls, String to, String from,String fromName, String replyTo, String cc, String bcc,
                                   String subject, String contentType, String content, String importance, String attachmentFileNames)
            throws MessagingException {

        final String METHOD_NAME = "sendMessageTLS";
        logger.entering(CLASS_NAME, METHOD_NAME,
                new Object[] { smtpHost, to, from, replyTo, cc, bcc, subject, contentType, content, importance,
                        attachmentFileNames });
