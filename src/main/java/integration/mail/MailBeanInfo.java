...
public class MailBeanInfo extends SimpleBeanInfo {
    ...
    public MethodDescriptor[] getMethodDescriptors() {
        ...
        try {
            MethodDescriptor descriptorList[] = {
                    ...
                    sendMessageMethodDescriptor(), sendMessageTLSMethodDescriptor() };
    ...
    private MethodDescriptor sendMessageMethodDescriptor()
        ...
        Method method = beanClass.getMethod("sendMessage", String.class, String.class, String.class, String.class, String.class,
        ...
        ParameterDescriptor param3bis = new ParameterDescriptor();
        param3bis.setShortDescription("The name displayed of the sender.");
        param3bis.setDisplayName("fromName");
        ...
        ParameterDescriptor params[] = { param1, param2, param3,param3bis, param4, param5, param6, param7, param8, param9,
                param10, param11 };
        MethodDescriptor methodDescriptor = new MethodDescriptor(method, params);
        logger.exiting(CLASS_NAME, METHOD_NAME, methodDescriptor);
        return methodDescriptor;
    ...
    private MethodDescriptor sendMessageTLSMethodDescriptor()
            throws NoSuchMethodException {
        final String METHOD_NAME = "sendMessageMethodDescriptor";
        logger.entering(CLASS_NAME, METHOD_NAME);

        Method method = beanClass.getMethod("sendMessageTLS", String.class,  String.class, String.class,String.class,boolean.class,
        ...
        ParameterDescriptor username = new ParameterDescriptor();
        username.setShortDescription("Username");
        username.setDisplayName("username");

        ParameterDescriptor password = new ParameterDescriptor();
        password.setShortDescription("Password");
        password.setDisplayName("password");

        ParameterDescriptor port = new ParameterDescriptor();
        port.setShortDescription("Port");
        port.setDisplayName("port");

        ParameterDescriptor tls = new ParameterDescriptor();
        tls.setShortDescription("TLS =  true or false");
        tls.setDisplayName("tls");
        ...
        ParameterDescriptor params[] = { param1, username, password, port, tls, param2, param3, param3bis,param4, param5, param6, param7, param8, param9,
                param10, param11 };
        MethodDescriptor methodDescriptor = new MethodDescriptor(method, params);
        logger.exiting(CLASS_NAME, METHOD_NAME, methodDescriptor);
        return methodDescriptor;
